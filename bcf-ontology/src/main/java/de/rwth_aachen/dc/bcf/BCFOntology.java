...
public class BCFOntology {
	...
	private void addComment(OntClass oc_Comment) {
		...
		DatatypeProperty dp_CommentText = ontology_model.createDatatypeProperty(this.bcf_ns + "has" + "CommentText");
		dp_CommentText.addComment("The comment text", "en");
		dp_CommentText.addDomain(oc_Comment);
		dp_CommentText.addRange(XSD.xstring);
		setObligatoryAttribute(oc_Comment, dp_CommentText);  // ATTR, since one per comment
