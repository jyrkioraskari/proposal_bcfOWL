...
public class CreateBCFOntology {
	...
	public CreateBCFOntology() {
		try {
			...
			oc_Project.addComment("The project contains reference information about the project the topics belong to.",
					"en");
			...
			ObjectProperty op_hasExtensionSchema = ontology_model
					.createObjectProperty(this.bcf_ns + "has" + "ExtensionSchema");
	...
	private void createVisualizationInfo(OntClass oc_BCF) {
		...
		ObjectProperty op_hasVisualizationInfo = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "VisualizationInfo");
		...
		ObjectProperty op_CameraViewPoint = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "CameraViewPoint");
		...
		ObjectProperty op_CameraDirection = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "CameraDirection");
		...
		ObjectProperty op_hasOrthogonalCamera = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "OrthogonalCamera");
		op_hasOrthogonalCamera.addDomain(oc_VisualizationInfo);
		op_hasOrthogonalCamera.addRange(oc_OrthogonalCamera);
		ObjectProperty op_ViewToWorldScale = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "ViewToWorldScale");
		...
		ObjectProperty op_hasPerspectiveCamera = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "PerspectiveCamera");
		...
		oc_ClippingPlanes.addComment(
				...
				"en");
		ObjectProperty op_hasClippingPlanes = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "ClippingPlanes");
		...
		oc_Bitmap.addComment(
				"A list of bitmaps can be used to add more information, for example, text in the visualization.", "en");
	...
	private void addComponents(OntClass oc_Components) {
		...
		oc_ViewSetupHints.addComment(
				...
				"en");
		ObjectProperty op_hasViewSetupHints = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "ViewSetupHints");
		...
		ObjectProperty op_AuthoringToolId = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "AuthoringToolId");
		op_AuthoringToolId.addDomain(oc_Component);

		OntClass oc_Visibility = ontology_model.createClass(this.bcf_ns + "Visibility");
		oc_Visibility.addComment(
	...
	private void addComponent(OntClass oc_Component) {
		...
		// TODO datatype string
		ObjectProperty op_OriginatingSystem = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "OriginatingSystem");
	...
	private void createMarkup(OntClass oc_BCF) {
		...
		OntClass oc_BimSnippet = ontology_model.createClass(this.bcf_ns + "BimSnippet");
		oc_BimSnippet.addComment(
				...
				"en");
		OntClass oc_DocumentReference = ontology_model.createClass(this.bcf_ns + "DocumentReference");
		oc_DocumentReference.addComment(
		...
		ObjectProperty op_hasBimSnippet = ontology_model.createObjectProperty(this.bcf_ns + "has" + "BimSnippet");
		op_hasBimSnippet.addDomain(oc_Markup);
		op_hasBimSnippet.addRange(oc_BimSnippet);
		addBimSnippet(oc_BimSnippet);

		ObjectProperty op_hasDocumentReference = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "DocumentReference");
		op_hasDocumentReference.addDomain(oc_Markup);
		op_hasDocumentReference.addRange(oc_DocumentReference);
		addDocumentReference(oc_DocumentReference);
	...
	private void addHeader(OntClass oc_Header) {
		...
		dp_IfcProject.addComment("IfcGuid Reference to the project to which this topic is related in the IFC file",
				"en");
		dp_IfcProject.addDomain(oc_Header);
		dp_IfcProject.addRange(XSD.xstring);
		setOptionalAttribute(oc_Header, dp_IfcProject);

		DatatypeProperty IfcSpatialStructureElement = ontology_model
				.createDatatypeProperty(this.bcf_ns + "has" + "IfcSpatialStructureElement");
		IfcSpatialStructureElement.addComment(
	...
	private void addTopicElements(OntClass oc_Topic) {
		...
		op_Priority.addComment("Topic priority. The list of possible values are defined in the extension schema.",
				"en");
		...
		op_Labels.addComment(
				"Tags for grouping Topics. The list of possible values are defined in the extension schema.", "en");
		...
		DatatypeProperty dp_ModifiedDate = ontology_model
				.createDatatypeProperty(this.bcf_ns + "has" + "Topic_ModifiedDate");
		dp_ModifiedDate.addComment(
		...
		ObjectProperty op_ModifiedAuthor = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "Topic_ModifiedAuthor");
		op_ModifiedAuthor.addComment(
				"User who modified the topic. Exists only when Topic has been modified after creation.", "en");
	...
	private void addBimSnippet(OntClass oc_BimSnippet) {
		ObjectProperty op_SnippetType = ontology_model.createObjectProperty(this.bcf_ns + "has" + "SnippetType");
		op_SnippetType.addComment("Type of the Snippet (Predefined list�)", "en");
		op_SnippetType.addDomain(oc_BimSnippet);
		setObligatoryAttribute(oc_BimSnippet, op_SnippetType);

		ObjectProperty op_Reference = ontology_model.createObjectProperty(this.bcf_ns + "has" + "Reference");
		op_Reference.addComment("URI to BimSnippet IFC.", "en");
		op_Reference.addDomain(oc_BimSnippet);
		setObligatoryElement(oc_BimSnippet, op_Reference);

		ObjectProperty op_ReferenceSchema = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "ReferenceSchema");
		op_ReferenceSchema.addComment("URI to BimSnippetSchema", "en");
		op_ReferenceSchema.addDomain(oc_BimSnippet);
		setOptionalElement(oc_BimSnippet, op_ReferenceSchema);
	}

	private void addDocumentReference(OntClass oc_DocumentReference) {
		DatatypeProperty dp_DocumentReferenceGuid = ontology_model
				.createDatatypeProperty(this.bcf_ns + "has" + "DocumentReferenceGuid");
		dp_DocumentReferenceGuid.addComment("Guid attribute for identifying it uniquely", "en");
		dp_DocumentReferenceGuid.addDomain(oc_DocumentReference);
		dp_DocumentReferenceGuid.addRange(XSD.xstring);
		setOptionalAttribute(oc_DocumentReference, dp_DocumentReferenceGuid);

		ObjectProperty op_ReferencedDocument = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "ReferencedDocument");
		op_ReferencedDocument.addComment("URI to document.", "en");
		op_ReferencedDocument.addDomain(oc_DocumentReference);
		setOptionalElement(oc_DocumentReference, op_ReferencedDocument);

		DatatypeProperty dp_Description = ontology_model.createDatatypeProperty(this.bcf_ns + "has" + "Description");
		dp_Description.addComment("Description of the document", "en");
		dp_Description.addDomain(oc_DocumentReference);
		dp_Description.addRange(XSD.xstring);
		setOptionalElement(oc_DocumentReference, dp_Description);
	}
	...
	private void addComment(OntClass oc_Comment) {
		...
		DatatypeProperty dp_ModifiedDate = ontology_model
				.createDatatypeProperty(this.bcf_ns + "has" + "Comment_ModifiedDate");
		...
		ObjectProperty op_ModifiedAuthor = ontology_model
				.createObjectProperty(this.bcf_ns + "has" + "Comment:ModifiedAuthor");
